...
\StringTok{  }\CommentTok{#geom_ribbon(aes(ymin = regs$lwr, ymax = regs$upr), fill = "gray90") +  }
\StringTok{  }\KeywordTok{geom_line}\NormalTok{(}\KeywordTok{aes}\NormalTok{(}\DataTypeTok{y =}\NormalTok{ regs}\OperatorTok{$}\NormalTok{mean)) }\OperatorTok{+}
